...
public class SUDOKU_FRAME extends javax.swing.JFrame {
 ...
 private boolean solutionIndicator=true;
 private boolean checkSolIndicator=true;
 ...
 private String solvedBoard [][] = {
    ...
    private void chooseNumber(JButton btn)
    {
    ...
    //function to set number on btn and set background as white
    private void setNumber(JButton btn)
    {
        if(selectedNumber.equals(""))
                    JOptionPane.showMessageDialog(this,"Please select any number", "SUCOKU GAME",JOptionPane.INFORMATION_MESSAGE);
        else
        {
            st.push(btn);
    ...
    private void showSolution(){
        JButton arr[]={r1c4,r1c7,r1c8,r1c9,
        ...
        for (int i = 0; i<9; i++){
            for (int j = 0; j<9; j++){
                ...
                if(flag)
                {
                    if(solutionIndicator==true)
                    {
                    btn[i][j].setText(solvedBoard[i][j]);
                    btn[i][j].setBackground(green);
                    }
                    else
                    {
                        btn[i][j].setText("");
        ...
        if(solutionIndicator==true)
        {
            solutionIndicator=false;
            solutionBtn.setText("HIDE SOL");
        }
        else
        {
            solutionIndicator=true;
   ...
   private void checkMoves()
   {
        ...
        {
                      JOptionPane.showMessageDialog(this,"SUDOKU Board is EMPTY!","SUDOKU",JOptionPane.INFORMATION_MESSAGE);
    ...
    private void initComponents() {
        ...
        r6c4.setBackground(new java.awt.Color(51, 153, 255));
        ...
        r5c2.setBackground(new java.awt.Color(51, 153, 255));
        ...
        r5c3.setBackground(new java.awt.Color(51, 153, 255));
        ...
        r6c2.setBackground(new java.awt.Color(51, 153, 255));
        ...
        r7c2.setBackground(new java.awt.Color(51, 153, 255));
        ...
        r8c1.setBackground(new java.awt.Color(51, 153, 255));
        ...
        r9c1.setBackground(new java.awt.Color(51, 153, 255));
        ...
        r8c4.setBackground(new java.awt.Color(51, 153, 255));
        ...
        checkMovesBtn.setBackground(new java.awt.Color(153, 0, 153));
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(undoBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 114, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(layout.createSequentialGroup()
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        .addGap(118, 118, 118)
                        .addComponent(solutionBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(26, 26, 26)
    ...
    private void r2c6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_r2c6ActionPerformed
        // TODO add your handling code here:
        JOptionPane.showMessageDialog(this,"This place is already been allocated", "SUCOKU GAME",JOptionPane.INFORMATION_MESSAGE);
...
//        setNumber(r1c9);
    ...
    private void exitBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exitBtnActionPerformed
       if( JOptionPane.showConfirmDialog(this,"Confirm to Exit from Game!","SUDOKU GAME",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_NO_OPTION)
       {
           System.exit(0);
       } 
